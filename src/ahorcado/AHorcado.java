...
//siguientes acciones 
        while (intentos > 0) {
            ...
            for (int i = 1; i < letras.length; i++) {    //Mostrando lineas de la palabra ingresada 
...
//de las letras que forman parte de la palabra 
                //ingresada entrara 
                if (letras[i].equals(letra[0])) {  //si la pabra no fue ingresada antes entrara 
...
//letra que ya estaba aparecera este mensaje 
            ...
            if (VD == true) { //reduciendo intentos 
